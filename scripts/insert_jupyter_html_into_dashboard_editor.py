...
def build_html(config: dict):
    ...
    # Đọc CSS files
    gridstack_css_path = script_dir / "assets" / "editor" / "gridstack.min.css"
    dashboardtify_css_path = script_dir / "assets" / "editor" / "dashboardtify.css"
    ...
    # Đọc JS files
    gridstack_js_path = script_dir / "assets" / "editor" / "gridstack-all.js"
    iconify_js_path = script_dir / "assets" / "editor" / "iconify.min.js"
    dashboardtify_js_path = script_dir / "assets" / "editor" / "dashboardtify.js"
